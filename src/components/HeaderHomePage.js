        ...
        <div class="header--nav flex justify-between items-center px-10 py-2.5">
          ...
          <div class="header--menu">
            <ul class="head--menu--list flex list-none">
              <li><a href="" class="header--menu--link ml-5 no-underline text-white text-[20px] font-extralight">Projects</a></li>
              <li><a href="" class="header--menu--link ml-5 no-underline text-white text-[20px] font-extralight">Technologies</a></li>
              <li><a href="" class="header--menu--link ml-5 no-underline text-white text-[20px] font-extralight">About me</a></li>
            </ul>
          </div>
          <div class="">
            <ul class="head--menu--list flex list-none">
