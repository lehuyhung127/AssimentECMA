  ...
  <div class="abc page-section">
    ...
    <div class="page-section__info flex justify-around items-center gap-8 mt-7 text-white">
      ...
      <div class="page-section__profile ">
        ...
        My short term goal is that I want to be a part of a Backend team, to build a platform that can show my skills and grow my career. I am always enthusiastic to grow myself along with the organization.</p>
    ...
    <div class="block text-center mt-24 ">
        <a class="button btn-2 button--colorful button--margin btn--primary py-3 px-10 border-none rounded-full" href="#">HIRE ME</a>
      </div>
  </div>
</section>
    `;
